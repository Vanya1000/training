    ...
    Выделяют 2 основных типа полиморфизма. 
      ...
      Параметрический(истинный)
        Задача: Реализовать функцию которая сможет принимать в себя неограниченное количество объектов унаследованных от Person
          Первое что приходит в голову, это написать функцию, которая принимает 3 аргумента. Массив объектов, созданных с person 2й массив созданных из разраб и 3й созд из просто работник. По каждому из массивов проитерироваться. И у каждого объекта вызвать метод, который отвечает за приветствие. (Но это максимально глупо, так как у нас может быть очень глубокая вложенность объектов.)
          !Но
          class Person {
            constructor(firstName, lastName, age) {
              this._firstName = firstName;
